...
class PhoneBookTest {
	...
	@BeforeEach
	void setUp() {
		List<PhoneBook.Person> people =
				new ArrayList<>(List.of(new PhoneBook.Person("nicola", "bicocchi", "3478001122"), new PhoneBook.Person("marzia", "neri", "3335566777"), new PhoneBook.Person("erica", "risi", "32d8123456")));
